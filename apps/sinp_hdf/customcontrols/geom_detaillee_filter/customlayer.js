...
var v_commune_geometry_detaillee = new CustomLayer("v_commune_geometry_detaillee", layer);

v_commune_geometry_detaillee.update_commune = function (code_insee) {
  console.log(code_insee);
  console.log(v_commune_geometry_detaillee)
}